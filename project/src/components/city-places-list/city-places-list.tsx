    ...
    <div className="cities">
      <div className="cities__places-container container">
        <section className="cities__places places">
          ...
          <b className="places__found" data-testid="city-places-found">{offers.length} places to stay in <span className="places__city-name">{City[cityCode as CityCode]}</span></b>
          <PlacesSorting/>
